...
echo "Color model"
starflat --dataset-path=$1 --config-path=$2/config_$4.yaml --output-path=$3/$dataset_name/$4/color --model=color --solve --plot --recap
# starflat --dataset-path=$1 --config-path=$2/config_$4.yaml --output-path=$3/$dataset_name/$4/color --model=color --plot

echo "Full model"
starflat --dataset-path=$1 --config-path=$2/config_$4.yaml --output-path=$3/$dataset_name/$4/full --model=full --solve --plot --recap
